...
public class MongoDBUtil {
	 ...
	 * @param mongoDBCursor 查询实体
	 */
	private static List<DBObject> find(final MongoDBCursor mongoDBCursor, DBObject dbObject,
			BasicDBObjectBuilder customField) {
...
//		try {
//			// 获取操作DB
//			DB db=MongoDBCommonUtil.getDB("127.0.0.1", 27017, "springboot-dbs", "null", "null");
//			MongoDBCursor mongoDBCursor = new MongoDBCursor();
//			mongoDBCursor.setDb(db); // 赋值DB
//			mongoDBCursor.setCollectionName("springboot-db"); // 赋值集合名
//			// 封装查询条件
//			Map<String, Object> fieldMap = new HashMap<String, Object>();
//			fieldMap.put("title", "by");
